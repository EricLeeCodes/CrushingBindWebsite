...
namespace Server.Controllers
{
    ...
    public class PostsController : ControllerBase
    {
        ...
        public PostsController(AppDBContext appDBContext, IWebHostEnvironment webHostEvnironment, IMapper mapper)
        {
        ...
        public async Task<IActionResult> Delete(int id)
        {
            try
            {
                ...
                if (postToDelete.ArchiveThumbnailImagePath != "uploads/placeholder.jpg")
                {
                    string fileName = postToDelete.ArchiveThumbnailImagePath.Split('/').Last();
